...
class CheckoutSettingForm extends SettingForm
{
    public function setup(): void
    {
        ...
        $this
            ...
            ->add(
                'minimum_order_amount_applies_after_discount',
                OnOffCheckboxField::class,
                OnOffFieldOption::make()
                    ->label(trans('plugins/ecommerce::setting.checkout.form.minimum_order_amount_applies_after_discount'))
                    ->value(get_ecommerce_setting('minimum_order_amount_applies_after_discount', false))
                    ->helperText(trans('plugins/ecommerce::setting.checkout.form.minimum_order_amount_applies_after_discount_helper'))
            )
            ->add(
