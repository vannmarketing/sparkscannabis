...
<body{!! Theme::bodyAttributes() !!}>
    ...
    <!-- Custom script to fix coupon application on mobile browsers -->
    <link href="{{ asset('css/coupon-handler.css?v=' . time()) }}" rel="stylesheet">
    <script src="{{ asset('js/coupon-handler.js?v=' . time()) }}"></script>
