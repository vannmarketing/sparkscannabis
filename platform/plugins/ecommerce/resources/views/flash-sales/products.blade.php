                ...
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col text-truncate">
                        ...
                        @if ($product->is_variation)
                            @php
                                $attributeInfo = '';
                                if (isset($product->variationInfo)) {
                                    ...
                                    foreach ($variationItems as $item) {
                                        $attributes[] = $item->attribute_set . ': ' . $item->attribute_value;
                                    }
                                    $attributeInfo = implode(', ', $attributes);
                                }
                            @endphp
                            @if ($attributeInfo)
                                <div class="small text-muted">{{ $attributeInfo }}</div>
                            @endif
                        @endif
                    </div>
                    <div class="col-auto">
    ...
    <div class="list-group-item" data-product-id="__id__">
        <div class="row align-items-center mb-3">
            ...
            <div class="col text-truncate">
                ...
                <div class="small text-muted variation-attributes-display"></div>
            </div>
            <div class="col-auto">
                <a
                    href="javascript:void(0)"
