...
class LogIndex
{
    ...
    public function __construct(public LogFile $file, protected ?string $query = null)
    {
    ...
    public function getPositionForIndex(int $indexToFind): ?int
    {
        ...
        foreach ($this->getChunkDefinitions() as $chunkDefinition) {
            ...
            foreach ($this->getChunkData($chunkDefinition['index']) as $tsIndex) {
                foreach ($tsIndex as $levelIndex) {
