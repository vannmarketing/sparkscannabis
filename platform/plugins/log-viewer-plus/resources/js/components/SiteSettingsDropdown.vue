                ...
                <div class="py-2">
                    ...
                    <MenuItem @click.stop.prevent="fileStore.clearCacheForAllFiles" v-slot="{ active }">
                        <button :class="[active ? 'active' : '']">
                            ...
                            <span v-show="!fileStore.cacheRecentlyCleared['*'] && !fileStore.clearingCache['*']"
                                >Clear indices for all files</span
                            >
                            <span v-show="!fileStore.cacheRecentlyCleared['*'] && fileStore.clearingCache['*']"
                                >Please wait...</span
                            >
                            <span v-show="fileStore.cacheRecentlyCleared['*']" class="text-brand-500"
                                >File indices cleared</span
                            >
                        </button>
                    </MenuItem>
