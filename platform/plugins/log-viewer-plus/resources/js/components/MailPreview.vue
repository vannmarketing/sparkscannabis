                ...
                <tr v-if="mail.attachments && mail.attachments.length > 0">
                    ...
                    <td>
                        <div
                            ...
                            :key="`mail-${mail.id}-attachment-${index}`"
                            class="mail-attachment-button"
                        >
                            <div class="flex items-center">
                                <PaperClipIcon class="w-4 h-4 mr-1 text-gray-500 dark:text-gray-400" />
                                <span>
                                    {{ attachment.filename }}
                                    <span class="opacity-60">({{ attachment.size_formatted }})</span>
                                </span>
                            </div>
                            <div>
                                <a
