...
class AdsServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        AdsForm::beforeRendering(function (): void {
            ...
            add_action('base_action_footer_after', function () {
                if (in_array(Route::currentRouteName(), ['ads.create', 'ads.edit'])) {
                    // Add JavaScript and CSS for active days functionality
                    echo '<script src="' . asset('vendor/core/plugins/ads/js/ads.js') . '" type="text/javascript"></script>';
                    echo '<link rel="stylesheet" href="' . asset('vendor/core/plugins/ads/css/ads.css') . '">';
                }
            }, 45);
        });
    }
